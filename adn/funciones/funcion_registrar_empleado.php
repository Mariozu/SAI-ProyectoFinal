...
/*aqui limpiamos las variable que provienen del formulario*/
    ...
    $telefono 	= trim(mysqli_real_escape_string($con,$_REQUEST['tel']));
        ...
        $clave=''.md5($passwd).'';
                    ...
                    require("../../conexion.php");
                    $status=1;
                    $sql = "INSERT INTO usuarios (nombre,apellido_pat,apellido_mat,num_celular,email,puesto,turno,calle_num,colonia,cp,telefono_casa,municipio,estado,status,contrasena,user  ,departamento,clave_check)"
                            . "VALUES ('$us','$app','$apm','$telcelu','$correo','$cargo','$turno','$calle','$colonia','$cp','$telefono','$municipio','$estado','1','$clave','$user','$dep','$clave2')";
