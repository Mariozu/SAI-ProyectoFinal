  ...
  if(!isset($_SESSION)) 
    ...
    $fecha2=$_REQUEST["fecha2"];
     while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                        ...
                        $conteo="SELECT hora_entrada, entrada FROM checador WHERE id_user='$row[id_emp]' AND fecha>='$fecha1' AND fecha<='$fecha2'";
                        ...
                        while ($ros=  mysqli_fetch_array($check)){
                            if($ros["hora_entrada"]>$ros["entrada"]){
    ...
    $list = '';
     while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
                        ...
                        echo "<td class = 'success'><a href = '?opc=3&id=".$row["id_emp"]."'>".$row["nombre"]."</a></td> ";
                        echo "<td class='success'> ".$row["apellido_pat"]."</td><td class='success'>".$row["apellido_mat"]."</td><td class='success'>".$row["turno"]."</td>";
                        $conteo="SELECT hora_entrada, entrada FROM checador WHERE id_user='$row[id_emp]'";
                        $check=  mysqli_query($con, $conteo);
                        $segundos="";
                        $minutos="";
                        $horas="";
