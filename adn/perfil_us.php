...
if(emial == "" || nombre == "" || paterno == "" || materno == ""){
  ...
  $().toastmessage('showErrorToast', "SE REQUIERE NO DEJAR NINGUN CAMPO VACIO!"); 
                    ...
                    $.ajax({
                            ...
                            if(response==1){
                                $().toastmessage('showSuccessToast',  "LOS DATOS DEL USUARIO HAN SIDO MODIFICADOS SATISFACTORIAMENTE ");
            
                        setTimeout('location.reload(true)',2000); 
                            }else{
                                $().toastmessage('showErrorToast', "ERROR AL GUARDAR LOS CAMBIOS");
                            }
                    });
  ...
  $().toastmessage('showErrorToast', "SE REQUIERE NO DEJAR NINGUN CAMPO VACIO!"); 
            ...
            $.ajax({
                    ...
                    id: $("#id").val(),
                     ...
                     if(response==1){
                                $().toastmessage('showSuccessToast',  "CONTRASEÑA MODIFICADA CORRECTAMENTE ");
...
<br><br>
                <div class="form-group">	
                    <label class="col-sm-2 control-label" for="entrada">Hora de Entrada:</label>
                    <div class="col-sm-3">
                        <input type="text" name="entrada"  class="form-control"  value="08:00:00" id="entrada" />
                     </div>    
                    <label class="col-sm-2 control-label" for="comida">Hora de comida:</label>
                    <div class="col-sm-3">
                        <input type="text" name="comida" class="form-control"  value="13:30:00" id="comida" />
                     </div> 
   <br><br>                 
                    <label class="col-sm-2 control-label" for="regreso">Regreso de comida:</label>
                    <div class="col-sm-3">
                        <input type="text" name="regreso" class="form-control"  value="14:30:00" id="regreso" />
                     </div> 
                    <label class="col-sm-2 control-label" for="salida">Hora de Salida:</label>
                    <div class="col-sm-3">
                        <input type="text" name="salida" class="form-control"  value="18:00:00" id="salida" />
                     </div> 
                </div>
<br><br>
                <div class="form-group">	
