...
*Fecha: 04/05/16.
 * 
*Descripcion: Seccion para ver los registros del checador
 * 
*Variables Globales: 
 * 
*Metodos: 
...
<div style = "width:90%; heigth:50%; margin-top:50px; margin-left:8%" >
    ...
    <div   class = "row" style = "margin-left:-100px;">
        <table class = "table">
            ...
            <tbody>
                <tr>
                    <?php 
                    include("PHPPaging/PHPPaging.lib.CHECK.php");
