...
if(isset($_REQUEST["buscar"])){
    ...
    $limit = 'LIMIT ' .($pagenum - 1) * $page_rows .',' .$page_rows;
    // This is your query again, it is for grabbing just one page worth of rows by applying $limit
    $sql = "SELECT fecha,hora_entrada,hora_comida,hora_regreso,hora_salida,id_emp,nombre,apellido_pat,apellido_mat,turno FROM checador JOIN usuarios WHERE id_emp=id_user ORDER BY id_entrada DESC $limit";
    $query = mysqli_query($con, $sql)  or die("Error: ".mysqli_error($con));;
    // This shows the user what page they are on, and the total number of pages
    $text1 = "Registros (<b>$rows</b>)&nbsp;&nbsp;";
    $text2 = "&nbsp;<b>$pagenum</b> de <b>$last</b><br>";
